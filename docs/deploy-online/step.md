...
`nest-admin-soybean`项目中自带数据库初始化脚本，打开`nest-admin-soybean/server/db/init.sql`，复制到`Navicat`的新建查询中，执行一下。
...
如果您有更好的流程，欢迎提交PR或者加入我们的交流群，提出更好的部署方式，优化`nest-admin-soybean`的部署流程。
