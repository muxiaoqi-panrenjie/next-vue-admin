-- DropIndex
DROP INDEX "sys_upload_file_md5_idx";
...
-- AlterTable
ALTER TABLE "sys_tenant" ADD COLUMN     "storage_quota" INTEGER NOT NULL DEFAULT 10240,
...
-- AlterTable
ALTER TABLE "sys_upload" ADD COLUMN     "is_latest" BOOLEAN NOT NULL DEFAULT true,
ADD COLUMN     "parent_file_id" VARCHAR(255),
